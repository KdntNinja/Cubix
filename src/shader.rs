...
/// Handles instantiation of shaders. The shaders can be found in the [`shaders`](https://github.com/janhohenheim/minecraft_clone_rust/tree/main/assets/shaders) directory.
...
/// Material for [`glowy.wgsl`](https://github.com/janhohenheim/minecraft_clone_rust/blob/main/assets/shaders/glowy.wgsl).
